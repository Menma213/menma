module.exports = {
    execute: function ({ baseUser, baseTarget, effectiveUser, effectiveTarget, jutsuData, effectHandlers }) {
        const trueDamage = Math.floor((baseTarget.maxHealth || baseTarget.health || 100) * 0.12);
        const scalingDamage = Math.floor(1500 * effectiveUser.power / effectiveTarget.defense);
